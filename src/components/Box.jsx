  ...
  return (
    ...
    <section className=' px-5 md:px-[60px] mt-[18px] group'>
        <div className="box-content size-25 border-2 w-full rounded-xl shadow-lg bg-bluePu">
            ...
            <div className=''>
            <span className='nmPeraturan'><a className='hover:text-slate-400' href="">Keputusan Menteri Pekerjaan Umum Nomor 176/KPTS/M/2025 tentang Penetapan Golongan Jenis Kendaraan Bermotor dan Penyesuaian Tarif Tol Pada Jalan Tol Tangerang-Merak</a></span>

            <div className='flex justify-start md:gap-3 gap-2'>
                <p className='tglPeraturan'>13 Februari 2025</p>
