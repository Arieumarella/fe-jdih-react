        ...
        <div className="hidden md:flex items-center font-roboto font-normal">
          ...
          <nav className="flex gap-8 text-sm font-medium text-white text-[25px] mr-[-64px]">
            ...
            <div className="relative group">
              ...
              {/* Submenu */}
              <ul className="absolute hidden group-hover:block bg-white text-black shadow-lg rounded-md py-2 w-[180px]">
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigateHandelClick("SiMPeL/Prolegnas"); }} className="block px-4 py-2 hover:bg-slate-100">Prolegnas RUU Prioritas Tahunan</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigateHandelClick("SiMPeL/Progsun"); }} className="block px-4 py-2 hover:bg-slate-100">Progsun PP/PERPRES</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigateHandelClick("SiMPeL/Proleg"); }} className="block px-4 py-2 hover:bg-slate-100">PROLEG PUPR</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigateHandelClick("SiMPeL/IpRPP"); }} className="block px-4 py-2 hover:bg-slate-100">IP RPP/RPERPRES</a></li>
                <li><a href="#" onClick={(e) => { e.preventDefault(); navigateHandelClick("SiMPeL/IpRpermen"); }} className="block px-4 py-2 hover:bg-slate-100">IP RPERMEN</a></li>
