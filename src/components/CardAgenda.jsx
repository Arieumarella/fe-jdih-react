...
<div className={`w-full md:w-[75%] mx-auto rounded-xl flex flex-col cursor-pointer overflow-hidden transition-all duration-300 ease-in-out ${openItems.includes(1) ? 'bg-white shadow-lg my-4' : 'bg-transparent shadow-none my-0'}`}
      onClick={() => toggleItem(1)}>
      
  <div className="p-4 md:p-6 bg-white shadow-md rounded-t-lg flex justify-between gap-4 items-start border">
    {/* Logo Kiri */}
    ...
    <div className="flex flex-col gap-2">
      ...
      <p className="text-sm md:text-[14px] text-slate-500 flex justify-center gap-2 mt-2 font-semibold font-roboto">
