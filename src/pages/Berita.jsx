...
const Home = () => {
    ...
    const paginateFunction = async () => {
      await getBeritaPagination(currentPage).then((result) => {
      ...
      <>
        ...
        <section className='h-full bg-slate-100 md:px-[180px] px-5 py-4 '>
          ...
          {posts?.length > 0 ? (
            ...
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden border border-gray-200 cursor-pointer"
