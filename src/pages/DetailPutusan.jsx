...
const DetailPutusan = () => {
    ...
    const details = [
      ...
      { label: "Judul", value: dataPutusan.judul },
      { label: "T.E.U. Badan / Pengarang", value: dataPutusan.teu },
      { label: "Nomor Putusan", value: dataPutusan.noperaturan },
      { label: "Jenis Peradilan", value: dataPutusan.teu },
      { label: "Singkatan Jenis", value: "PTUN" },
      { label: "Tempat Peradilan", value: dataPutusan.tempat_terbit },
      { label: "Tanggal Dibacakan", value: formatDate(dataPutusan?.tanggal) },
      { label: "Sumber", value: dataPutusan.sumber },
      { label: "Bahasa", value: dataPutusan.bahasa },
      { label: "Bidang Hukum", value: "Hukum Administrasi Negara" },
      { label: "Lokasi", value: dataPutusan.lokasi }
    ];
